...
# Dependencies
RUN dpkg --add-architecture i386 && apt-get update && apt-get install -yq libstdc++6:i386 zlib1g:i386 libncurses5:i386 lib32z1 ant maven monodevelop mono-gmcs nunit --no-install-recommends
...
ENV ANDROID_SDK_COMPONENTS platform-tools,build-tools-23.0.0,build-tools-21.1.2,android-23,android-22,source-21,extra-android-support,extra-android-m2repository,extra-google-m2repository
